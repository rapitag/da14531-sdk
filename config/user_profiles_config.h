...
/// Manufacturer Name
#define APP_DIS_MANUFACTURER_NAME       ("rapitag GmbH")
#define APP_DIS_MANUFACTURER_NAME_LEN   (sizeof(APP_DIS_MANUFACTURER_NAME) - 1)

/// Model Number String
#define APP_DIS_MODEL_NB_STR            ("Gen5_devkit")
...
#define APP_DIS_HARD_REV_STR            ("Gen5_rev0")
...
#define APP_DIS_SW_REV_STR              ("4.0.0")
 ...
 */
#define APP_DIS_PNP_ID                  ("\x01\x98\x05\x00\x00\x00\x01")
