...
This crate is a wrapper for the manufacturer's SDK. In order to build it, you need to first download the SDK version `6.0.22.1401`.
In order to compile this crate you need to set the `SDK_PATH` environment variable to the SDK path, e.g. `SDK_PATH=/path/to/my/sdk/6.0.22.1401`
